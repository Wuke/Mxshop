    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goods_sn', models.CharField(default='', max_length=50, verbose_name='唯一商品编号')),
                ('name', models.CharField(max_length=300, verbose_name='商品名')),
                ('click_num', models.IntegerField(default=0, verbose_name='点击数')),
                ('sold_num', models.IntegerField(default=0, verbose_name='购买数')),
                ('fav_num', models.IntegerField(default=0, verbose_name='收藏数')),
                ('goods_number', models.IntegerField(default=0, verbose_name='库存')),
                ('market_price', models.FloatField(default=0, verbose_name='市场价')),
                ('store_price', models.FloatField(default=0, verbose_name='本店价')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
                ('goods', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='iamge', to='goods.Goods', verbose_name='商品')),
            ],
            options={
                'verbose_name': '商品图',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category_type', models.CharField(choices=[(1, '一级目录'), (2, '二级目录'), (3, '三级目录')], help_text='类目级别', max_length=10, verbose_name='类目级别')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dd_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
