...
class GoodsCategory(models.Model):
    ...
    desc = models.CharField(default='',max_length=100,verbose_name='类别描述',help_text='类别描述')
...
class Goods(models.Model):
    "商品"
    category = models.ForeignKey(GoodsCategory,null=True,blank=True,verbose_name='商品类目',on_delete=models.CASCADE)
    goods_sn = models.CharField(max_length=50,default='',verbose_name='唯一商品编号')
    name = models.CharField(max_length=300,verbose_name='商品名')
    click_num = models.IntegerField(default=0,verbose_name='点击数')
    sold_num = models.IntegerField(default=0,verbose_name='购买数')
...
class GoodsImage(models.Model):
    ...
    goods = models.ForeignKey(Goods,verbose_name='商品',related_name='iamge',on_delete=models.CASCADE)
